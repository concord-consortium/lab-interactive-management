# Generated by `$ rails generate lab:models` on 16 Jul 2013 16:07:58PM
# Depends on the definition of the md2d model type in the lab project
# GENERATED
class Md2d < ActiveRecord::Base

  store :json_rep, :accessors => [:viewOptions, :atom, :element, :pairwiseLJProperties, :obstacle, :rectangle, :radialBond, :angularBond, :restraint, :textBox, :quantumDynamics, :photon, :imagePath, :minX, :maxX, :minY, :maxY, :width, :height, :unitsScheme, :lennardJonesForces, :coulombForces, :temperatureControl, :targetTemperature, :modelSampleRate, :gravitationalField, :timeStep, :dielectricConstant, :realisticDielectricEffect, :solventForceFactor, :solventForceType, :additionalSolventForceMult, :additionalSolventForceThreshold, :polarAAEpsilon, :viscosity, :timeStepsPerTick, :DNAState, :DNA, :DNAMutations, :useQuantumDynamics, :url]
