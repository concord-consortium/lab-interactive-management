...
# Depends on the definition of the solar-system model type in the lab project
# GENERATED
class Solar-system < ActiveRecord::Base

  store :json_rep, :accessors => [:viewOptions, :body, :textBox, :imagePath, :minX, :maxX, :minY, :maxY, :width, :height, :unitsScheme, :modelSampleRate, :timeStep, :timeStepsPerTick, :horizontalWrapping, :verticalWrapping, :url]
